...
DEVENV_STATE='/home/user/src/head-first-c/.devenv/state'
export DEVENV_STATE
...
if [ -z "${LOCALE_ARCHIVE-}" ]; then
  export LOCALE_ARCHIVE=/nix/store/nr0j6ziq2356b7qd3q3fnvwzcv64hiyg-glibc-locales-2.42-67/lib/locale/locale-archive
fi
...
if [ ! -L "$DEVENV_DOTFILE/profile" ] || [ "$(/nix/store/97d5ygrvqj55f4nx1x34wfdcc7qn11c0-coreutils-9.11/bin/readlink $DEVENV_DOTFILE/profile)" != "/nix/store/qsqph2axa86pyxs5422c3jb9cw6rh5zx-devenv-profile" ]
then
  ln -snf /nix/store/qsqph2axa86pyxs5422c3jb9cw6rh5zx-devenv-profile "$DEVENV_DOTFILE/profile"
fi
...
mkdir -p /run/user/1000/devenv-4bab785
ln -snf /run/user/1000/devenv-4bab785 /home/user/src/head-first-c/.devenv/run



# Check whether the direnv integration is out of date.
{
  if [[ ":${DIRENV_ACTIVE-}:" == *":/home/user/src/head-first-c:"* ]]; then
...
out='/nix/store/qp8i412kfssrmp65j6zg2nhqxf5nmzs7-devenv-shell-env'
export out
...
nativeBuildInputs='/nix/store/ci8zzrskpy76f5xzqshyxpyk1hnalbb5-bash-interactive-5.3p15-dev /nix/store/ywawkcgrvwsc5x4wwb7c50j97jwlzwdf-clang-tools-21.1.8 /nix/store/w60q4s3anfrlnn72841kw60fsjc0qmhk-stdenv-linux /nix/store/zg22421nym5dxikl92978lqj6xf4jkax-gnumake-4.4.1 /nix/store/2ximi5n5qbl4kq4zkp2glv259szcap0m-ccls-0.20250815.1 /nix/store/prdwby9xlwcvskl801l24dm9fd6qb07k-gdb-17.2 /nix/store/irqj9v60dkggysa8yziykkxl5fd9s0al-valgrind-3.27.1-dev /nix/store/zg22421nym5dxikl92978lqj6xf4jkax-gnumake-4.4.1 /nix/store/irqj9v60dkggysa8yziykkxl5fd9s0al-valgrind-3.27.1-dev /nix/store/0v0raqk1qw5g2a21km4xa1hwhaq4s976-pkg-config-wrapper-0.29.2 /nix/store/0v0raqk1qw5g2a21km4xa1hwhaq4s976-pkg-config-wrapper-0.29.2'
export nativeBuildInputs
prefix='/nix/store/qp8i412kfssrmp65j6zg2nhqxf5nmzs7-devenv-shell-env'
...
RANLIB='ranlib'
export RANLIB
DEVENV_TASK_FILE='/nix/store/j7mf6h31shwh2qh6pbzfjqs9pfixmpp4-tasks.json'
export DEVENV_TASK_FILE
NIX_LDFLAGS='-rpath /nix/store/qp8i412kfssrmp65j6zg2nhqxf5nmzs7-devenv-shell-env/lib  -L/nix/store/ywawkcgrvwsc5x4wwb7c50j97jwlzwdf-clang-tools-21.1.8/lib -L/nix/store/prdwby9xlwcvskl801l24dm9fd6qb07k-gdb-17.2/lib -L/nix/store/ywawkcgrvwsc5x4wwb7c50j97jwlzwdf-clang-tools-21.1.8/lib -L/nix/store/prdwby9xlwcvskl801l24dm9fd6qb07k-gdb-17.2/lib'
export NIX_LDFLAGS
SIZE='size'
export SIZE
IFS=' 	
...
export name
DEVENV_DOTFILE='/home/user/src/head-first-c/.devenv'
...
DEVENV_ROOT='/home/user/src/head-first-c'
export DEVENV_ROOT
DEVENV_RUNTIME='/run/user/1000/devenv-4bab785'
...
export HOST_PATH
NIX_CFLAGS_COMPILE=' -frandom-seed=qp8i412kfs -isystem /nix/store/ci8zzrskpy76f5xzqshyxpyk1hnalbb5-bash-interactive-5.3p15-dev/include -isystem /nix/store/zg22421nym5dxikl92978lqj6xf4jkax-gnumake-4.4.1/include -isystem /nix/store/prdwby9xlwcvskl801l24dm9fd6qb07k-gdb-17.2/include -isystem /nix/store/irqj9v60dkggysa8yziykkxl5fd9s0al-valgrind-3.27.1-dev/include -isystem /nix/store/ci8zzrskpy76f5xzqshyxpyk1hnalbb5-bash-interactive-5.3p15-dev/include -isystem /nix/store/zg22421nym5dxikl92978lqj6xf4jkax-gnumake-4.4.1/include -isystem /nix/store/prdwby9xlwcvskl801l24dm9fd6qb07k-gdb-17.2/include -isystem /nix/store/irqj9v60dkggysa8yziykkxl5fd9s0al-valgrind-3.27.1-dev/include'
...
phases='buildPhase'
export phases
DEVENV_PROFILE='/nix/store/qsqph2axa86pyxs5422c3jb9cw6rh5zx-devenv-profile'
...
exec /tmp/devenv-envHx0Qdp/script 