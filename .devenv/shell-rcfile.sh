...
source "/home/user/src/head-first-c/.devenv/shell-env.sh"
...
__devenv_reload_apply() {
    ...
    if [ -f "/tmp/devenv-reload-121501.sh" ]; then
        ...
        source "/tmp/devenv-reload-121501.sh"
        rm -f "/tmp/devenv-reload-121501.sh"
